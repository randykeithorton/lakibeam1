...
# <launch>
#     <node name="richbeam_lidar" pkg="lakibeam1" type="lakibeam1_pcd_node" output="screen">
#     <remap from="/richbeam_lidar/pcd" to="/pcd" />
#         <param name="frame_id" type="string" value="laser"/><!--frame_id设置-->
#         <param name="output_topic" type="string" value="pcd" /><!--topic设置-->
...
#     </node>
#     <node name="rviz" pkg="rviz" type="rviz" args="-d $(find lakibeam1)/rviz/lakibeam1_pcd.rviz" />
# </launch>
...
def generate_launch_description():
    ...
    rviz_config_dir = os.path.join(lakibeam1_pcd_dir,'rviz','lakibeam1_pcd.rviz')
